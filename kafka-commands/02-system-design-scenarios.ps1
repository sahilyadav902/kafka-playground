# =============================================================================
# KAFKA SYSTEM DESIGN SCENARIOS (Windows PowerShell Version)
...
$schemaV1 = @{
    schema = '{"type":"record","name":"Order","fields":[{"name":"orderId","type":"string"},{"name":"total","type":"double"}]}'
} | ConvertTo-Json

curl.exe -X POST http://localhost:8081/subjects/orders-value/versions `
  -H "Content-Type: application/vnd.schemaregistry.v1+json" `
  -d $schemaV1

# Register schema v2 (added optional field — backward compatible)
$schemaV2 = @{
    schema = '{"type":"record","name":"Order","fields":[{"name":"orderId","type":"string"},{"name":"total","type":"double"},{"name":"currency","type":["null","string"],"default":null}]}'
} | ConvertTo-Json
...
curl.exe http://localhost:8081/subjects/orders-value/versions

# Get a specific version
curl.exe http://localhost:8081/subjects/orders-value/versions/1
